    ...
    public class MinimapRenderer : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (showNorthIcon == true)
            {
                ...
                //Push the north icon to far away in forward and grab it to the border of polygon collider of minimap renderer (put the icon in center of border of minimap renderer)
                northImageComponent.rectTransform.anchoredPosition = new Vector2(0, 4096);
            ...
            foreach (MinimapItemOfPool item in minimapItemsForHighlightPool)
            {
                ...
                //Push the highlighted icon to far away in forward and grab it to the border of polygon collider of minimap renderer (put the icon in center of border of minimap renderer)
                item.icon.rectTransform.anchoredPosition = new Vector2(0, 4096);
